...
export default function ProductCardHorizontal({ coffee }: ProductCardProps) {
  ...
  return (
    <button
      onClick={handleClick}
      className="relative flex flex-row bg-gray-300 hover:bg-primary-50 border rounded-2xl p-2 ease-in"
    >
      <img
        src={coffee.image}
      ...
      <div className="absolute bottom-2 right-2">
        <div className={classNames(
          ...
          isSameItem? "text-primary border border-primary" : "bg-primary bg-gray-300"
        )}>
